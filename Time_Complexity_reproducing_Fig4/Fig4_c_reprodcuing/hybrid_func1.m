...
fit=0;
x1=5*ones(1,D);
tmp1 = 100*frastrigin((x-o)./repmat(lamda(1,:),ps,1))/frastrigin(x1./lamda(1,:));
tmp2 = 100*fweierstrass((x-o)./repmat(lamda(3,:),ps,1))/fweierstrass(x1./lamda(3,:));
tmp3 = 100*fgriewank((x-o)./repmat(lamda(5,:),ps,1))/fgriewank(x1./lamda(5,:));
tmp4 = 100*felliptic((x-o)./repmat(lamda(7,:),ps,1))/felliptic(x1./lamda(7,:));
tmp5 = 100*fsphere((x-o)./repmat(lamda(9,:),ps,1))/fsphere(x1./lamda(9,:));
