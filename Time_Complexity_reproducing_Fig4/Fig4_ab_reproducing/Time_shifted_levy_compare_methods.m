    ...
    for i=1:maxGen
        for j=1:ps
            ...
            if fitness(j)<fitnessgbest
                gbest=pop(j,:);
                fitnessgbest=fitness(j);
                gbest_all(i) = shifted_levy(gbest,M);%*****************************************************************
...
load('CLPSO_data.mat');
save time_all time1 time2 time3 time4 time5 time6 time7 time8 time9 time10 time11
save ff_all ff_end1 ff_end2 ff_end3 ff_end4 ff_end5 ff_end6 ff_end7 ff_end8 ff_end10 ff_end11 ff_end12

% time_mean = [mean(time1),mean(time2),mean(time3),mean(time4),mean(time5),mean(time6),mean(time7),...
%     mean(time8),mean(time9),mean(time10),mean(time11), 1.142888089000000];
