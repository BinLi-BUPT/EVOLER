...
popMax = 600;                                  % Variable Range [-popmax: popmax]
popMin=-popMax;
...
for iiii = 1 : num_all
    ...
    Trail_times = 23;                          % The times of hierarchy reconstruction strategy, to reduce the problem space search range
    ...
    for ii  = 1 : Trail_times
        [global_optimum,pop_div1,pop_div2] = Search_30D_Initial(max_ite,min_ite,s-1,Discret_leng,M);
        max_ite = pop_div1;
        min_ite = pop_div2;
    end
    ...
    Trail_times2 = 4;                         % The times of hierarchy reconstruction strategy based on low-rank sampling
    for ii  = 1 : Trail_times2
        [global_optimum,pop_div1,pop_div2] = Recon_30D_Initial(max_ite,min_ite,s,Discret_leng,M);
        max_ite = pop_div1;
        min_ite = pop_div2;
    end
