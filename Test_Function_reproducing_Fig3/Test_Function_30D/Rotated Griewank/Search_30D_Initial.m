function [Initial_index,p_max,p_min] = Search_30D_Initial(popmax,popmin,s,Discret_leng,M)
D = length(popmax);
for ii = 1 : D
                            ...
                            for kk1 = 1 : s
                                for oo1 = 1 : s
                                    for pp1 = 1 : s
                                        ...
                                        A1_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_griewank(ind_cal,M);
                                    end
                                end
                            end
                        end
...
for pp1 = 1 : s
    ...
    A2_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_griewank(ind_cal,M);
end
end
end
end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : s
                                    for pp1 = 1 : s
                                        ...
                                        A3_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_griewank(ind_cal,M);
                                    end
                                end
                            end
                        end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : Discret_leng
                                    for pp1 = 1 : s
                                        ...
                                        A4_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_griewank(ind_cal,M);
                                    end
                                end
                            end
                        end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : Discret_leng
                                    for pp1 = 1 : Discret_leng
                                        ...
                                        A5_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_griewank(ind_cal,M);
                                    end
                                end
                            end
                        end
