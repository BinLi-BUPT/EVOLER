                            ...
                            for kk1 = 1 : s
                                for oo1 = 1 : s
                                    for pp1 = 1 : s
                                        ...
                                        A1_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_rest(ind_cal,M);
                                    end
                                end
                            end
                        end
...
for pp1 = 1 : s
    ...
    A2_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_rest(ind_cal,M);
end
end
end
end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : s
                                    for pp1 = 1 : s
                                        ...
                                        A3_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_rest(ind_cal,M);
                                    end
                                end
                            end
                        end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : Discret_leng
                                    for pp1 = 1 : s
                                        ...
                                        A4_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_rest(ind_cal,M);
                                    end
                                end
                            end
                        end
                            ...
                            for kk1 = 1 : Discret_leng
                                for oo1 = 1 : Discret_leng
                                    for pp1 = 1 : Discret_leng
                                        ...
                                        A5_test(ii,jj,kk,oo,pp,ii1,jj1,kk1,oo1,pp1) = rotated_rest(ind_cal,M);
                                    end
                                end
                            end
                        end
