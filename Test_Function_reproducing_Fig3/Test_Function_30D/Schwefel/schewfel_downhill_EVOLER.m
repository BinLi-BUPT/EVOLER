...
for iiii = 1 : num_all
    ...
    Trail_time = 6;                            % The repeating times of dichotomy strategy based on low-rank sampling
   ...
   PDF_num_proposed_downhill(iiii) = PDF_cal16;
    ...
    Y = 10000*ones(1,MaxDT+N_add);          % Assuming the large fitness in the first reconstruction stage
    Y(N_add+1:end) = yy16;
    ff_end16(iiii,:)=Y;
end
