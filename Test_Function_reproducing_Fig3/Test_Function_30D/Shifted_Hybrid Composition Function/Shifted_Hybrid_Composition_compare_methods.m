...
popMax= 5;
popMin=-popMax;
des_val= 2e-2;  %If the output result is less than the threshold 'des_val', the global optimum is found  
vMax=0.15*(popMax); 
vMin=(-1)*vMax;
...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=shifted_hybrid_func1(initPop(i,:),M);%*****************************************************************
    end
    initpBest=initPop;
    ...
    for i=1:maxGen
        for j=1:ps
            ...
            fitness(j)=shifted_hybrid_func1(pop(j,:),M);%************************************************************************
        ...
        for j=1:D
            for i=1:ceil(ps/D)
                ...
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                 fit1=shifted_hybrid_func1(temp1,M);
                 fit2=shifted_hybrid_func1(pBest1,M);%***************************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=shifted_hybrid_func1(temp1,M);fit2=shifted_hybrid_func1(pBest1,M);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
        ...
        for i=1:p_s
            ...
            s_fitness(i)=shifted_hybrid_func1(s_pop(i,:),M);%*************************************************************
    ...
    for k=1:maxGen
        for i=1:ps
            ...
            fitness(i)=shifted_hybrid_func1(pop(i,:),M);%****************************************************************
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=shifted_hybrid_func1(reshape(Pop(j,k,:),1,D),M);%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=shifted_hybrid_func1(reshape(Pop(groupNum,k,:),1,D),M);%*************************************************************************************
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            ...
            xFitness=shifted_hybrid_func1(pop(iParticles,:),M);    
...
%             yBest = xBest(nMin,:);
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=shifted_hybrid_func1(pop(index,:),M);%*****************************************************************
    ...
    for i=1:maxGen
        ...
        for j=1:ps
            ...
            fitness_u=shifted_hybrid_func1(u,M);%**********************************
    ...
    for i=1:(D+1)
        ...
        fit_S(i)=shifted_hybrid_func1(S(:,i),M);
    end
    ...
    for i=1:maxGen
        ...
        fit_Vr=shifted_hybrid_func1(Vr,M);%***********************
        if fit_Vr<=fit_Vl % Expansion:he reflection perform berter than the best position. 
            ...
            fit_Ve=shifted_hybrid_func1(Ve,M);%******************
            if fit_Ve<fit_Vl
                S(:,1)=[];      S=[S,Ve];
        ...
        elseif fit_Vr<=fit_Vh % Contraction: the reflection performs better than the worst position but worse than the second worst position.
            ...
            fit_Vc=shifted_hybrid_func1(Vc,M);%*******************************
            if fit_Vc<fit_Vh % The contruction performs better than the worst position.
                ...
                for j=1:D
                    ...
                    fit_S(j)=shifted_hybrid_func1(S(:,j),M);
                end
            end
...
da_1_Pro = load('Shifted_Pro_data_hybrid');  
