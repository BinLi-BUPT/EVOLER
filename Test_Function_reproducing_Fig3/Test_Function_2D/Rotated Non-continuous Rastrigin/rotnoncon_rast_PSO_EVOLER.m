...
for iiii = 1 : num_all
    ...
    N_add = round((s*(length(Discret_leng_int))+s*(length(Discret_leng_int))-s*s)/N); % The overall required samples to reconstruct an attenion subspace, which is used in the final plot.  
