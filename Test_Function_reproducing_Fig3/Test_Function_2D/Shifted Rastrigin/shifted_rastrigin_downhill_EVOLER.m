...
Discret_leng = 11;                              % Discrete size of the original problem space; M=N=Discret_leng;
...
for iiii = 1 : num_all
    ...
    Trail_time = 5;                             % The times of hierarchy reconstruction strategy based on low-rank sampling
    for ii = 1 : Trail_time
