...
%% 
N_add=2;
des_val= 1e-31;  %If the output result is less than the threshold 'des_val', the global optimum is found    
D=2;
ps=50;
maxGen=500;
num_all = 500;
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=levy(temp1);fit2=levy(pBest1);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=levy(reshape(Pop(j,k,:),1,D));%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=levy(reshape(Pop(groupNum,k,:),1,D));%*************************************************************************************
...
levy_2D_fitness{1}=ff_end1;%standard pso
levy_2D_fitness{2}=ff_end2;%dpso
levy_2D_fitness{3}=ff_end3;%cpso-s
levy_2D_fitness{4}=ff_end4;%cpso-h
levy_2D_fitness{5}=ff_end5;%clpso
levy_2D_fitness{6}=ff_end6;%mcpso
levy_2D_fitness{7}=ff_end7;%npso
levy_2D_fitness{8}=ff_end8;%gcpso
levy_2D_fitness{9}=ff_end9;%mpcpso
levy_2D_fitness{10}=ff_end10;%dnspso
levy_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
levy_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
levy_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
levy_2D_fitness{14}=ff_end14;
save('levy_2D_fitness','levy_2D_fitness')
s=xlswrite('levy_2D_fitness.xlsx',{'des_val'},'levy_2D_fitness','A1');
s=xlswrite('levy_2D_fitness.xlsx',des_val,'levy_2D_fitness','B1');
s=xlswrite('levy_2D_fitness.xlsx',{'method'},'levy_2D_fitness','A3');
s=xlswrite('levy_2D_fitness.xlsx',{'fitness'},'levy_2D_fitness','B3');
s=xlswrite('levy_2D_fitness.xlsx',{'standard PSO'},'levy_2D_fitness','A5');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{1},'levy_2D_fitness','B5');
s=xlswrite('levy_2D_fitness.xlsx',{'DPSO'},'levy_2D_fitness','A510');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{2},'levy_2D_fitness','B510');
s=xlswrite('levy_2D_fitness.xlsx',{'CPSO-S'},'levy_2D_fitness','A1015');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{3},'levy_2D_fitness','B1015');
s=xlswrite('levy_2D_fitness.xlsx',{'CPSO-H'},'levy_2D_fitness','A1520');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{4},'levy_2D_fitness','B1520');
s=xlswrite('levy_2D_fitness.xlsx',{'CLPSO'},'levy_2D_fitness','A2025');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{5},'levy_2D_fitness','B2025');
s=xlswrite('levy_2D_fitness.xlsx',{'MCPSO'},'levy_2D_fitness','A2530');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{6},'levy_2D_fitness','B2530');
s=xlswrite('levy_2D_fitness.xlsx',{'NPSO'},'levy_2D_fitness','A3035');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{7},'levy_2D_fitness','B3035');
s=xlswrite('levy_2D_fitness.xlsx',{'GCPSO'},'levy_2D_fitness','A3540');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{8},'levy_2D_fitness','B3540');
s=xlswrite('levy_2D_fitness.xlsx',{'MPCPSO'},'levy_2D_fitness','A4045');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{9},'levy_2D_fitness','B4045');
s=xlswrite('levy_2D_fitness.xlsx',{'DNSPSO'},'levy_2D_fitness','A4550');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{10},'levy_2D_fitness','B4550');
s=xlswrite('levy_2D_fitness.xlsx',{'Local PSO'},'levy_2D_fitness','A5055');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{11},'levy_2D_fitness','B5055');
s=xlswrite('levy_2D_fitness.xlsx',{'EVOLER'},'levy_2D_fitness','A5560');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{12},'levy_2D_fitness','B5560');
s=xlswrite('levy_2D_fitness.xlsx',{'EVOLER_Local'},'levy_2D_fitness','A6065');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{13},'levy_2D_fitness','B6065');
s=xlswrite('levy_2D_fitness.xlsx',{'EVOLER_Downhill'},'levy_2D_fitness','A6570');
s=xlswrite('levy_2D_fitness.xlsx',levy_2D_fitness{14},'levy_2D_fitness','B6570');
