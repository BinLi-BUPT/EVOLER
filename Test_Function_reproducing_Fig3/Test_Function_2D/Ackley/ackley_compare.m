...
da_1_Pro = load('Pro_data_ack');  % run the file 'schewfel_EVOLER' to generate this data
...
title('2-D ackley');
legend('Standard PSO','DPSO','CPSO-S','CPSO-H','CLPSO','MCPSO','NPSO','GCPSO','PSOEVOLER','MPCPSO','DNSPSO','Local PSO','location','SouthWest');
save 'all_data.mat';
