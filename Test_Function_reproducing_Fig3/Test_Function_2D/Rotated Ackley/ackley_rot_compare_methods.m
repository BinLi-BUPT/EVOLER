...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=ackley_rot(initPop(i,:),M);%*****************************************************************
    end
    initpBest=initPop;
        ...
        for j=1:D
            for i=1:ceil(ps/D)
                ...
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                 fit1=ackley_rot(temp1,M);
                 fit2=ackley_rot(pBest1,M);%***************************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=ackley_rot(temp1,M);fit2=ackley_rot(pBest1,M);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
        ...
        for i=1:p_s
            ...
            s_fitness(i)=ackley_rot(s_pop(i,:),M);%*************************************************************
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=ackley_rot(reshape(Pop(j,k,:),1,D),M);%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=ackley_rot(reshape(Pop(groupNum,k,:),1,D),M);%*************************************************************************************
...
%                 g_worst = pop(j,:);
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            %xFitness = ackley_rot();
            xFitness=ackley_rot(pop(iParticles,:),M);    
...
%         if fitnessgbest > des_val
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=ackley_rot(pop(index,:),M);%*****************************************************************
...
ackley_rot_2D_fitness={};


ackley_rot_2D_fitness{1}=ff_end1;%standard pso
ackley_rot_2D_fitness{2}=ff_end2;%dpso
ackley_rot_2D_fitness{3}=ff_end3;%cpso-s
ackley_rot_2D_fitness{4}=ff_end4;%cpso-h
ackley_rot_2D_fitness{5}=ff_end5;%clpso
ackley_rot_2D_fitness{6}=ff_end6;%mcpso
ackley_rot_2D_fitness{7}=ff_end7;%npso
ackley_rot_2D_fitness{8}=ff_end8;%gcpso
ackley_rot_2D_fitness{9}=ff_end9;%mpcpso
ackley_rot_2D_fitness{10}=ff_end10;%dnspso
ackley_rot_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
ackley_rot_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
ackley_rot_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
ackley_rot_2D_fitness{14}=ff_end14;
save('ackley_rot_2D_fitness','ackley_rot_2D_fitness')
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'des_val'},'2D_ackley_rot_fitness','A1');
s=xlswrite('ackley_rot_2D_fitness.xlsx',des_val,'2D_ackley_rot_fitness','B1');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'method'},'2D_ackley_rot_fitness','A3');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'fitness'},'2D_ackley_rot_fitness','B3');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'standard PSO'},'2D_ackley_rot_fitness','A5');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{1},'2D_ackley_rot_fitness','B5');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'DPSO'},'2D_ackley_rot_fitness','A510');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{2},'2D_ackley_rot_fitness','B510');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'CPSO-S'},'2D_ackley_rot_fitness','A1015');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{3},'2D_ackley_rot_fitness','B1015');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'CPSO-H'},'2D_ackley_rot_fitness','A1520');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{4},'2D_ackley_rot_fitness','B1520');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'CLPSO'},'2D_ackley_rot_fitness','A2025');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{5},'2D_ackley_rot_fitness','B2025');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'MCPSO'},'2D_ackley_rot_fitness','A2530');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{6},'2D_ackley_rot_fitness','B2530');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'NPSO'},'2D_ackley_rot_fitness','A3035');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{7},'2D_ackley_rot_fitness','B3035');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'GCPSO'},'2D_ackley_rot_fitness','A3540');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{8},'2D_ackley_rot_fitness','B3540');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'MPCPSO'},'2D_ackley_rot_fitness','A4045');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{9},'2D_ackley_rot_fitness','B4045');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'DNSPSO'},'2D_ackley_rot_fitness','A4550');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{10},'2D_ackley_rot_fitness','B4550');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'Local PSO'},'2D_ackley_rot_fitness','A5055');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{11},'2D_ackley_rot_fitness','B5055');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'EVOLER'},'2D_ackley_rot_fitness','A5560');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{12},'2D_ackley_rot_fitness','B5560');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'EVOLER_Local'},'2D_ackley_rot_fitness','A6065');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{13},'2D_ackley_rot_fitness','B6065');
s=xlswrite('ackley_rot_2D_fitness.xlsx',{'EVOLER_Downhill'},'2D_ackley_rot_fitness','A6570');
s=xlswrite('ackley_rot_2D_fitness.xlsx',ackley_rot_2D_fitness{14},'2D_ackley_rot_fitness','B6570');
