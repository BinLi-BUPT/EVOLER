...
%% 
N_add=9;
des_val= 1e-16;  %If the output result is less than the threshold 'des_val', the global optimum is found  
D=2;
ps=50;
maxGen=500;
num_all = 500;
...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=non_continuous_rastrigin(initPop(i,:));%*****************************************************************
    end
    initpBest=initPop;
    ...
    for i=1:maxGen
        for j=1:ps
            ...
            fitness(j)=non_continuous_rastrigin(pop(j,:));%************************************************************************
        ...
        for j=1:D
            for i=1:ceil(ps/D)
                ...
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                 fit1=non_continuous_rastrigin(temp1);
                 fit2=non_continuous_rastrigin(pBest1);%***************************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=non_continuous_rastrigin(temp1);fit2=non_continuous_rastrigin(pBest1);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
        ...
        for i=1:p_s
            ...
            s_fitness(i)=non_continuous_rastrigin(s_pop(i,:));%*************************************************************
    ...
    for k=1:maxGen
        for i=1:ps
            ...
            fitness(i)=non_continuous_rastrigin(pop(i,:));%****************************************************************
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=non_continuous_rastrigin(reshape(Pop(j,k,:),1,D));%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=non_continuous_rastrigin(reshape(Pop(groupNum,k,:),1,D));%*************************************************************************************
...
%                 g_worst = pop(j,:);
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            %xFitness = non_continuous_rastrigin();
            xFitness=non_continuous_rastrigin(pop(iParticles,:));    
...
%         if fitnessgbest > des_val
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=non_continuous_rastrigin(pop(index,:));%*****************************************************************
    ...
    for i=1:maxGen
        ...
        for j=1:ps
            ...
            fitness_u=non_continuous_rastrigin(u);%**********************************
...
non_continuous_rastrigin_2D_fitness={};


non_continuous_rastrigin_2D_fitness{1}=ff_end1;%standard pso
non_continuous_rastrigin_2D_fitness{2}=ff_end2;%dpso
non_continuous_rastrigin_2D_fitness{3}=ff_end3;%cpso-s
non_continuous_rastrigin_2D_fitness{4}=ff_end4;%cpso-h
non_continuous_rastrigin_2D_fitness{5}=ff_end5;%clpso
non_continuous_rastrigin_2D_fitness{6}=ff_end6;%mcpso
non_continuous_rastrigin_2D_fitness{7}=ff_end7;%npso
non_continuous_rastrigin_2D_fitness{8}=ff_end8;%gcpso
non_continuous_rastrigin_2D_fitness{9}=ff_end9;%mpcpso
non_continuous_rastrigin_2D_fitness{10}=ff_end10;%dnspso
non_continuous_rastrigin_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
non_continuous_rastrigin_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
non_continuous_rastrigin_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
non_continuous_rastrigin_2D_fitness{14}=ff_end14;
save('non_continuous_rastrigin_2D_fitness','non_continuous_rastrigin_2D_fitness')
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'des_val'},'non_con_rastrigin_2D_fitness','A1');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',des_val,'non_con_rastrigin_2D_fitness','B1');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'method'},'non_con_rastrigin_2D_fitness','A3');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'fitness'},'non_con_rastrigin_2D_fitness','B3');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'standard PSO'},'non_con_rastrigin_2D_fitness','A5');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{1},'non_con_rastrigin_2D_fitness','B5');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'DPSO'},'non_con_rastrigin_2D_fitness','A510');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{2},'non_con_rastrigin_2D_fitness','B510');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'CPSO-S'},'non_con_rastrigin_2D_fitness','A1015');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{3},'non_con_rastrigin_2D_fitness','B1015');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'CPSO-H'},'non_con_rastrigin_2D_fitness','A1520');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{4},'non_con_rastrigin_2D_fitness','B1520');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'CLPSO'},'non_con_rastrigin_2D_fitness','A2025');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{5},'non_con_rastrigin_2D_fitness','B2025');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'MCPSO'},'non_con_rastrigin_2D_fitness','A2530');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{6},'non_con_rastrigin_2D_fitness','B2530');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'NPSO'},'non_con_rastrigin_2D_fitness','A3035');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{7},'non_con_rastrigin_2D_fitness','B3035');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'GCPSO'},'non_con_rastrigin_2D_fitness','A3540');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{8},'non_con_rastrigin_2D_fitness','B3540');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'MPCPSO'},'non_con_rastrigin_2D_fitness','A4045');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{9},'non_con_rastrigin_2D_fitness','B4045');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'DNSPSO'},'non_con_rastrigin_2D_fitness','A4550');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{10},'non_con_rastrigin_2D_fitness','B4550');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'Local PSO'},'non_con_rastrigin_2D_fitness','A5055');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{11},'non_con_rastrigin_2D_fitness','B5055');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'EVOLER'},'non_con_rastrigin_2D_fitness','A5560');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{12},'non_con_rastrigin_2D_fitness','B5560');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'EVOLER_Local'},'non_con_rastrigin_2D_fitness','A6065');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{13},'non_con_rastrigin_2D_fitness','B6065');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',{'EVOLER_Downhill'},'non_con_rastrigin_2D_fitness','A6570');
s=xlswrite('non_continuous_rastrigin_2D_fitness.xlsx',non_continuous_rastrigin_2D_fitness{14},'non_con_rastrigin_2D_fitness','B6570');
