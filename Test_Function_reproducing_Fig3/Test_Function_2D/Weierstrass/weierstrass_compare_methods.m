...
popMin= - popMax;
des_val= 1e-10;  %If the output result is less than the threshold 'des_val', the global optimum is found  vMax=0.15*(popMax); 
vMax=0.15*(popMax);
vMin=(-1)*vMax;
...
limit_de = 1e-15;
da_1_Pro = load('Pro_data_weier');  % run the file 'schewfel_EVOLER' to generate this data
