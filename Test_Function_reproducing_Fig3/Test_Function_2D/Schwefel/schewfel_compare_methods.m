...
%% 
N_add=2;
des_val= 3e-5;   %If the output result is less than the threshold 'des_val', the global optimum is found  
...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=schewfel(initPop(i,:));%*****************************************************************
    end
    initpBest=initPop;
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=schewfel(temp1);fit2=schewfel(pBest1);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=schewfel(reshape(Pop(j,k,:),1,D));%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=schewfel(reshape(Pop(groupNum,k,:),1,D));%*************************************************************************************
...
%                 g_worst = pop(j,:);
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            %xFitness = schewfel();
            xFitness=schewfel(pop(iParticles,:));    
...
%         if fitnessgbest > des_val
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=schewfel(pop(index,:));%*****************************************************************
...
schewfel_2D_fitness{1}=ff_end1;%standard pso
schewfel_2D_fitness{2}=ff_end2;%dpso
schewfel_2D_fitness{3}=ff_end3;%cpso-s
schewfel_2D_fitness{4}=ff_end4;%cpso-h
schewfel_2D_fitness{5}=ff_end5;%clpso
schewfel_2D_fitness{6}=ff_end6;%mcpso
schewfel_2D_fitness{7}=ff_end7;%npso
schewfel_2D_fitness{8}=ff_end8;%gcpso
schewfel_2D_fitness{9}=ff_end9;%mpcpso
schewfel_2D_fitness{10}=ff_end10;%dnspso
schewfel_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
schewfel_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
schewfel_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
schewfel_2D_fitness{14}=ff_end14;
save('schewfel_2D_fitness','schewfel_2D_fitness')
s=xlswrite('schewfel_2D_fitness.xlsx',{'des_val'},'2D_schewfel_Fitness','A1');
s=xlswrite('schewfel_2D_fitness.xlsx',des_val,'2D_schewfel_Fitness','B1');
s=xlswrite('schewfel_2D_fitness.xlsx',{'method'},'2D_schewfel_Fitness','A3');
s=xlswrite('schewfel_2D_fitness.xlsx',{'fitness'},'2D_schewfel_Fitness','B3');
s=xlswrite('schewfel_2D_fitness.xlsx',{'standard PSO'},'2D_schewfel_Fitness','A5');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{1},'2D_schewfel_Fitness','B5');
s=xlswrite('schewfel_2D_fitness.xlsx',{'DPSO'},'2D_schewfel_Fitness','A510');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{2},'2D_schewfel_Fitness','B510');
s=xlswrite('schewfel_2D_fitness.xlsx',{'CPSO-S'},'2D_schewfel_Fitness','A1015');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{3},'2D_schewfel_Fitness','B1015');
s=xlswrite('schewfel_2D_fitness.xlsx',{'CPSO-H'},'2D_schewfel_Fitness','A1520');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{4},'2D_schewfel_Fitness','B1520');
s=xlswrite('schewfel_2D_fitness.xlsx',{'CLPSO'},'2D_schewfel_Fitness','A2025');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{5},'2D_schewfel_Fitness','B2025');
s=xlswrite('schewfel_2D_fitness.xlsx',{'MCPSO'},'2D_schewfel_Fitness','A2530');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{6},'2D_schewfel_Fitness','B2530');
s=xlswrite('schewfel_2D_fitness.xlsx',{'NPSO'},'2D_schewfel_Fitness','A3035');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{7},'2D_schewfel_Fitness','B3035');
s=xlswrite('schewfel_2D_fitness.xlsx',{'GCPSO'},'2D_schewfel_Fitness','A3540');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{8},'2D_schewfel_Fitness','B3540');
s=xlswrite('schewfel_2D_fitness.xlsx',{'MPCPSO'},'2D_schewfel_Fitness','A4045');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{9},'2D_schewfel_Fitness','B4045');
s=xlswrite('schewfel_2D_fitness.xlsx',{'DNSPSO'},'2D_schewfel_Fitness','A4550');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{10},'2D_schewfel_Fitness','B4550');
s=xlswrite('schewfel_2D_fitness.xlsx',{'Local PSO'},'2D_schewfel_Fitness','A5055');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{11},'2D_schewfel_Fitness','B5055');
s=xlswrite('schewfel_2D_fitness.xlsx',{'EVOLER'},'2D_schewfel_Fitness','A5560');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{12},'2D_schewfel_Fitness','B5560');
s=xlswrite('schewfel_2D_fitness.xlsx',{'EVOLER_Local'},'2D_schewfel_Fitness','A6065');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{13},'2D_schewfel_Fitness','B6065');
s=xlswrite('schewfel_2D_fitness.xlsx',{'EVOLER_Downhill'},'2D_schewfel_Fitness','A6570');
s=xlswrite('schewfel_2D_fitness.xlsx',schewfel_2D_fitness{14},'2D_schewfel_Fitness','B6570');
