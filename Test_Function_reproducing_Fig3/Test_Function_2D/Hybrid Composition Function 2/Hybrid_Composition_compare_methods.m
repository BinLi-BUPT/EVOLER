...
close all
%% 
des_val= 1e-30;   %If the output result is less than the threshold 'des_val', the global optimum is found  
N_add=3;
...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=hybrid_func2(initPop(i,:));%*****************************************************************
    end
    initpBest=initPop;
        ...
        for j=1:D
            for i=1:ceil(ps/D)
                ...
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                 fit1=hybrid_func2(temp1);
                 fit2=hybrid_func2(pBest1);%***************************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=hybrid_func2(temp1);fit2=hybrid_func2(pBest1);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
        ...
        for i=1:p_s
            ...
            s_fitness(i)=hybrid_func2(s_pop(i,:));%*************************************************************
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=hybrid_func2(reshape(Pop(j,k,:),1,D));%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=hybrid_func2(reshape(Pop(groupNum,k,:),1,D));%*************************************************************************************
...
%                 g_worst = pop(j,:);
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            %xFitness = hybrid_func2();
            xFitness=hybrid_func2(pop(iParticles,:));    
...
%         if fitnessgbest > des_val
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=hybrid_func2(pop(index,:));%*****************************************************************
...
hybrid_func2_2D_fitness={};


hybrid_func2_2D_fitness{1}=ff_end1;%standard pso
hybrid_func2_2D_fitness{2}=ff_end2;%dpso
hybrid_func2_2D_fitness{3}=ff_end3;%cpso-s
hybrid_func2_2D_fitness{4}=ff_end4;%cpso-h
hybrid_func2_2D_fitness{5}=ff_end5;%clpso
hybrid_func2_2D_fitness{6}=ff_end6;%mcpso
hybrid_func2_2D_fitness{7}=ff_end7;%npso
hybrid_func2_2D_fitness{8}=ff_end8;%gcpso
hybrid_func2_2D_fitness{9}=ff_end9;%mpcpso
hybrid_func2_2D_fitness{10}=ff_end10;%dnspso
hybrid_func2_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
hybrid_func2_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
hybrid_func2_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
hybrid_func2_2D_fitness{14}=ff_end14;
save('hybrid_func2_2D_fitness','hybrid_func2_2D_fitness')
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'des_val'},'Hybrid_Com2_2D_fitness','A1');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',des_val,'Hybrid_Com2_2D_fitness','B1');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'method'},'Hybrid_Com2_2D_fitness','A3');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'fitness'},'Hybrid_Com2_2D_fitness','B3');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'standard PSO'},'Hybrid_Com2_2D_fitness','A5');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{1},'Hybrid_Com2_2D_fitness','B5');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'DPSO'},'Hybrid_Com2_2D_fitness','A510');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{2},'Hybrid_Com2_2D_fitness','B510');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'CPSO-S'},'Hybrid_Com2_2D_fitness','A1015');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{3},'Hybrid_Com2_2D_fitness','B1015');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'CPSO-H'},'Hybrid_Com2_2D_fitness','A1520');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{4},'Hybrid_Com2_2D_fitness','B1520');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'CLPSO'},'Hybrid_Com2_2D_fitness','A2025');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{5},'Hybrid_Com2_2D_fitness','B2025');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'MCPSO'},'Hybrid_Com2_2D_fitness','A2530');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{6},'Hybrid_Com2_2D_fitness','B2530');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'NPSO'},'Hybrid_Com2_2D_fitness','A3035');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{7},'Hybrid_Com2_2D_fitness','B3035');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'GCPSO'},'Hybrid_Com2_2D_fitness','A3540');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{8},'Hybrid_Com2_2D_fitness','B3540');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'MPCPSO'},'Hybrid_Com2_2D_fitness','A4045');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{9},'Hybrid_Com2_2D_fitness','B4045');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'DNSPSO'},'Hybrid_Com2_2D_fitness','A4550');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{10},'Hybrid_Com2_2D_fitness','B4550');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'Local PSO'},'Hybrid_Com2_2D_fitness','A5055');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{11},'Hybrid_Com2_2D_fitness','B5055');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'EVOLER'},'Hybrid_Com2_2D_fitness','A5560');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{12},'Hybrid_Com2_2D_fitness','B5560');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'EVOLER_Local'},'Hybrid_Com2_2D_fitness','A6065');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{13},'Hybrid_Com2_2D_fitness','B6065');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',{'EVOLER_Downhill'},'Hybrid_Com2_2D_fitness','A6570');
s=xlswrite('Hybrid_Composition2_2D_fitness.xlsx',hybrid_func2_2D_fitness{14},'Hybrid_Com2_2D_fitness','B6570');
...
semilogy(Xdata_de,mean(ff_end14(:,1:maxGen+1),1),'Color',[0.90,0.63,0.75],'Linewidth',1,'MarkerIndices',marker_idx);%downhill evoler
hold on;
