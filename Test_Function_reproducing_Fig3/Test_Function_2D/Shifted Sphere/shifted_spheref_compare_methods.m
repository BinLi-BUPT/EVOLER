...
for run=1:num_all
    ...
    for i=1:ps
        ...
        initFitness(i)=shifted_spheref(initPop(i,:),M);%*****************************************************************
    end
    initpBest=initPop;
    ...
    for i=1:maxGen
        for j=1:ps
            ...
            fitness(j)=shifted_spheref(pop(j,:),M);%************************************************************************
        ...
        for j=1:D
            for i=1:ceil(ps/D)
                ...
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                 fit1=shifted_spheref(temp1,M);
                 fit2=shifted_spheref(pBest1,M);%***************************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
    ...
    for k=1:maxGen
        for j=1:D
            for i=1:p_s
                ...
                temp1=gBest;pBest1=gBest;
                temp1(j)=pop(i,j);pBest1(j)=pBest(j);
                fit1=shifted_spheref(temp1,M);fit2=shifted_spheref(pBest1,M);%****************************************************
                if fit1<fit2
                    pBestFit(i)=fit1;
                    pBest(i,j)=pop(i,j);
                end
        ...
        for i=1:p_s
            ...
            s_fitness(i)=shifted_spheref(s_pop(i,:),M);%*************************************************************
    ...
    for k=1:maxGen
        for i=1:ps
            ...
            fitness(i)=shifted_spheref(pop(i,:),M);%****************************************************************
    ...
    for i=1:maxGen
        for j=1:groupNum-1
            for k=1:p_s
                ...
                Fitness(j,k)=shifted_spheref(reshape(Pop(j,k,:),1,D),M);%******************************************************************************
        ...
        for k=1:p_s
            ...
            fit=shifted_spheref(reshape(Pop(groupNum,k,:),1,D),M);%*************************************************************************************
...
%                 g_worst = pop(j,:);
    ...
    for iIteration = 1:maxGen
        for iParticles = 1:ps
            %xFitness = shifted_spheref();
            xFitness=shifted_spheref(pop(iParticles,:),M);    
...
%         if fitnessgbest > des_val
    ...
    for i=1:maxGen
        ...
        for j=1:N2
            ...
            fitness(index)=shifted_spheref(pop(index,:),M);%*****************************************************************
...
shifted_spheref_2D_fitness={};


shifted_spheref_2D_fitness{1}=ff_end1;%standard pso
shifted_spheref_2D_fitness{2}=ff_end2;%dpso
shifted_spheref_2D_fitness{3}=ff_end3;%cpso-s
shifted_spheref_2D_fitness{4}=ff_end4;%cpso-h
shifted_spheref_2D_fitness{5}=ff_end5;%clpso
shifted_spheref_2D_fitness{6}=ff_end6;%mcpso
shifted_spheref_2D_fitness{7}=ff_end7;%npso
shifted_spheref_2D_fitness{8}=ff_end8;%gcpso
shifted_spheref_2D_fitness{9}=ff_end9;%mpcpso
shifted_spheref_2D_fitness{10}=ff_end10;%dnspso
shifted_spheref_2D_fitness{11}=ff_end11;%local pso

da_1_Pro = load('Pro_data');
ff_end12=da_1_Pro.Fit_pro(1:num_all,:);
shifted_spheref_2D_fitness{12}=ff_end12;%pso evoler
da_l_Pro2=load('Pro_Local_data');
ff_end13=da_l_Pro2.Fit_pro(1:num_all,:);
shifted_spheref_2D_fitness{13}=ff_end13;%local pso evoler
da_l_Pro3=load('Pro_downhill_data');
ff_end14=da_l_Pro3.Fit_pro(1:num_all,:);
shifted_spheref_2D_fitness{14}=ff_end14;
save('shifted_spheref_2D_fitness','shifted_spheref_2D_fitness')
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'des_val'},'2D_shif_sphe_fitness','A1');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',des_val,'2D_shif_sphe_fitness','B1');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'method'},'2D_shif_sphe_fitness','A3');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'fitness'},'2D_shif_sphe_fitness','B3');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'standard PSO'},'2D_shif_sphe_fitness','A5');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{1},'2D_shif_sphe_fitness','B5');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'DPSO'},'2D_shif_sphe_fitness','A510');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{2},'2D_shif_sphe_fitness','B510');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'CPSO-S'},'2D_shif_sphe_fitness','A1015');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{3},'2D_shif_sphe_fitness','B1015');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'CPSO-H'},'2D_shif_sphe_fitness','A1520');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{4},'2D_shif_sphe_fitness','B1520');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'CLPSO'},'2D_shif_sphe_fitness','A2025');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{5},'2D_shif_sphe_fitness','B2025');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'MCPSO'},'2D_shif_sphe_fitness','A2530');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{6},'2D_shif_sphe_fitness','B2530');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'NPSO'},'2D_shif_sphe_fitness','A3035');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{7},'2D_shif_sphe_fitness','B3035');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'GCPSO'},'2D_shif_sphe_fitness','A3540');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{8},'2D_shif_sphe_fitness','B3540');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'MPCPSO'},'2D_shif_phe_fitness','A4045');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{9},'2D_shif_sphe_fitness','B4045');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'DNSPSO'},'2D_shif_sphe_fitness','A4550');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{10},'2D_shif_sphe_fitness','B4550');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'Local PSO'},'2D_shif_sphe_fitness','A5055');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{11},'2D_shif_sphe_fitness','B5055');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'EVOLER'},'2D_shif_sphe_fitness','A5560');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{12},'2D_shif_sphe_fitness','B5560');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'EVOLER_Local'},'2D_shif_sphe_fitness','A6065');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{13},'2D_shif_sphe_fitness','B6065');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',{'EVOLER_Downhill'},'2D_shif_sphe_fitness','A6570');
s=xlswrite('shifted_spheref_2D_fitness.xlsx',shifted_spheref_2D_fitness{14},'2D_shif_sphe_fitness','B6570');
